...
const TYPES = [
  ...
  { id: 'water',     name: 'Water',     icon: '<img src="images/water.png" alt="Water energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#3a8fd4' },
  { id: 'grass',     name: 'Grass',     icon: '<img src="images/grass.png" alt="Grass energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#3aab3a' },
  { id: 'lightning', name: 'Lightning', icon: '<img src="images/lightning.png" alt="Lightning energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#c8a010' },
  { id: 'psychic',   name: 'Psychic',   icon: '<img src="images/psychic.png" alt="Psychic energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#d45aaf' },
  { id: 'fighting',  name: 'Fighting',  icon: '<img src="images/fighting.png" alt="Fighting energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#b85c2a' },
  { id: 'darkness',  name: 'Darkness',  icon: '<img src="images/darkness.png" alt="Darkness energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#4a3a6a' },
  { id: 'metal',     name: 'Metal',     icon: '<img src="images/metal.png" alt="Metal energy" style="width:100%;height:100%;object-fit:contain;">', bg: '#6a7a8a' },
